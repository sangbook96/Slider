package vn.adt.slider.views.fragment;
...
import vn.adt.slider.event.OnPosterClickListener;
import vn.adt.slider.posters.BitmapImage;
import vn.adt.slider.posters.DrawableImage;
import vn.adt.slider.posters.ImagePoster;
import vn.adt.slider.posters.Poster;
import vn.adt.slider.posters.RawVideo;
import vn.adt.slider.posters.RemoteImage;
import vn.adt.slider.posters.RemoteVideo;
import vn.adt.slider.posters.RemoteVideoPath;
import vn.adt.slider.posters.VideoPoster;
import vn.adt.slider.views.AdjustableImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(poster!=null){
            if(poster instanceof ImagePoster){
                ...
                if(poster instanceof RawVideo){
                ...
                }else  if (poster instanceof RemoteVideoPath){
                    RemoteVideoPath video = (RemoteVideoPath) poster;
                    ...
                    ExtractorMediaSource mediaSource = new ExtractorMediaSource(fileDataSource.getUri(),
                            factory,new DefaultExtractorsFactory(), new Handler(),null);
                    player.prepare(mediaSource);
                }
